...
- **0.2.4:** Fix für "Fehler beim Öffnen der Konfiguration (500)" auf
  neueren Home-Assistant-Versionen – `config_entry` im `OptionsFlow`
  wurde nicht mehr manuell im `__init__` gesetzt (dort inzwischen eine
